      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <div className="w-[64px] flex justify-end">
          {doneToday ? (
            ...
            <span className="rounded-full bg-gradient-to-b from-primary to-[hsl(var(--primary)/0.85)] text-primary-foreground text-[11px] font-semibold px-2.5 py-1 whitespace-nowrap shadow-[0_3px_8px_-2px_hsl(var(--primary)/0.55),inset_0_1px_0_rgba(255,255,255,0.35)] ring-1 ring-primary/40 animate-pulse">
              сделать
            </span>
          )}
        </div>
