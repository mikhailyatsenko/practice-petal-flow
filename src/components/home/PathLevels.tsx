...
const LEVELS: Level[] = [
  {
    ...
    task: {
      videoTitle: "Как выполнить уровень 1 — Найди союзника",
      ...
      videoDescription:
        "Аркадий объясняет зачем нужен Бадди, как его найти, как провести первый созвон и что важно сделать после него. Посмотри видео перед тем как начать — это сэкономит время и поможет сделать всё правильно с первого раза.",
      videoChapters: [
      ...
      tasks: [
        {
          title: "Найти Бадди",
          description:
            "Бадди — это твой партнёр по развитию с которым ты встречаешься раз в неделю на созвон. Вместе вы делитесь успехами, поддерживаете друг друга и помогаете двигаться вперёд. Исследования показывают что люди которые работают с партнёром по accountability достигают своих целей в разы чаще чем те кто действует в одиночку. Именно поэтому Бадди — это первое что нужно сделать в клубе. Найти Бадди можно в разделе Комьюнити — там есть анкеты участников которые тоже ищут партнёра.",
          done: true,
        },
        {
          title: "Провести созвон 60 минут",
          description:
            "Первый созвон с Бадди — это знакомство и начало вашего партнёрства. На нём важно рассказать о себе, своих целях и желаниях, и узнать то же самое о своём партнёре. Формат созвона простой: первые 20 минут ты рассказываешь о своих успехах и планах, следующие 20 минут слушаешь Бадди, последние 20 минут вы вместе обсуждаете задачи на следующую неделю. Такой формат помогает каждому быть услышанным и уйти с созвона с конкретным планом действий.",
          done: true,
        },
        {
          title: "Написать желание Бадди",
          description:
            "После первого созвона тебе нужно заполнить карточку своего Бадди. Это важный шаг — когда ты записываешь желания и цели своего партнёра, ты начинаешь лучше понимать куда он движется и как именно можешь ему помогать. Карточка Бадди — это не формальность, это инструмент который делает ваше партнёрство по-настоящему глубоким и осознанным. Чем лучше ты знаешь своего Бадди, тем точнее вопросы ты задаёшь и тем ценнее твоя поддержка для него. В карточке пять вопросов — главная цель, три желания, сильные стороны, что мешает достигать успеха, и в чём нужна твоя поддержка. На заполнение уйдёт 5 минут, а польза от этого остаётся на всё время вашего партнёрства.",
          active: true,
