...
const LEVELS: Level[] = [
  ...
  },
  {
    ...
    task: {
      ...
      tasks: [
        {
          title: "Соединиться в четвёрку",
          description:
            "Найди вторую пару Бадди и соединитесь в Четвёрку. Четвёрка — это две пары которые идут вместе, поддерживают друг друга и делают практики синхронно. Зайди в раздел Четвёрка и отправь или прими запрос на соединение.",
          active: true,
          goTo: "Комьюнити → Четвёрка",
        },
        {
          title: "Сделать 7 хитов подряд",
          description:
            "Хит — это когда все четверо в один день выполнили свои практики. Ваша задача — сделать 7 хитов подряд, без пропусков. Это закрепит ритм и даст почувствовать силу группы. Договоритесь о времени и держитесь друг за друга.",
          goTo: "Маховик успеха → Сегодняшние практики",
        },
      ],
    },
