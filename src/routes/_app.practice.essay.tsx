...
export const Route = createFileRoute("/_app/practice/essay")({
  head: () => ({
    meta: [
      { title: "Сочинение жизни мечты — Клуб «Моя жизнь»" },
      {
        name: "description",
        content:
          "Пиши сочинение о своей идеальной жизни — каждый день минимум 100 символов.",
      },
    ],
  }),
          ...
          <div className="mt-3 animate-fade-up">
            ...
            {howTab === "text" && (
              <div className="space-y-3">
                ...
                <HowCard
                  title="🎯 Как выполнять?"
                  text={`Пиши минимум 100 символов в день — это примерно 2-3 предложения. Сочинение растёт до 2000 символов. Когда заполнится — первые предложения сверху будут стираться по мере добавления новых снизу. Это нормально: обновляй, дополняй, детализируй.`}
                >
                  <div
...
🏆 Награда: +1 очко ежедневно за выполнение.`}
            ...
            {howTab === "video" && (
              <HowVideoCards
                first={{
                  title: "🎬 Как писать сочинение «Сочинение жизни мечты»",
                  duration: "7:00",
                  caption:
