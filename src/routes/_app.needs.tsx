...
const RATINGS: { key: Rating; color: string; emoji: string; label: string }[] = [
  ...
  { key: "0", color: "#ef4444", emoji: "🔴", label: "Полностью не удовлетворена (0–20%)" },
  { key: "1", color: "#92400e", emoji: "🟤", label: "Удовлетворена минимально (20–40%)" },
  { key: "2", color: "#f97316", emoji: "🟠", label: "Удовлетворена частично (40–60%)" },
  { key: "3", color: "#facc15", emoji: "🟡", label: "Почти удовлетворена (60–80%)" },
  { key: "4", color: "#16a34a", emoji: "🟢", label: "Полностью удовлетворена (80–100%)" },
];
    ...
    <div className="pb-8">
      ...
      <div className="px-4 space-y-4">
        ...
        >
          ...
          <div>🔴 — Потребность полностью не удовлетворена (0–20%)</div>
          <div>🟤 — Потребность удовлетворена минимально (20–40%)</div>
          <div>🟠 — Потребность удовлетворена частично (40–60%)</div>
          <div>🟡 — Потребность почти удовлетворена (60–80%)</div>
          <div>🟢 — Потребность полностью удовлетворена (80–100%)</div>
        </div>
