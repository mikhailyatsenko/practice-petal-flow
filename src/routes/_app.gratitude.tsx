...
const INFO_TEXT: Record<Category, string | null> = {
  ...
  golden:
    "Золотые моменты — это редкие мгновения от которых захватывает дух. Те моменты, которые запоминаются на всю жизнь. Важно их фиксировать и сохранять.\n\nПримеры:\n✨ Закат на море, когда время будто остановилось\n✨ Первая улыбка вашего ребёнка\n✨ Объятие близкого человека после долгой разлуки\n✨ Момент, когда вы услышали «да» на важный вопрос\n✨ Тишина в горах на рассвете\n✨ Овации после вашего выступления\n✨ Случайная встреча, изменившая всё\n✨ Минута, когда вы поняли — вы по-настоящему счастливы",
};
