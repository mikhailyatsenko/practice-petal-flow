...
const initialPractices: PracticeRow[] = [
  ...
  { id: "essay",     title: "Моя жизнь мечты",             streakDays: 0,  doneToday: false, history: [], level: 0, progress: -6 },
  { id: "skill",     title: "Воплощение намерения",            streakDays: 22, doneToday: false, history: [], level: 2, progress: 22 },
