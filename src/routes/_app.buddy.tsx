      ...
      {!contactOpen ? (
        ...
        <div className="mt-2 space-y-2">
          <a
            ...
            className="tap w-full rounded-xl py-2.5 text-[13px] font-bold text-white inline-flex items-center justify-center gap-2"
          ...
          <button
            ...
            className="tap w-full rounded-xl py-2 text-[12px] font-medium"
            style={{ background: "transparent", border: "1px solid #ede8df", color: "var(--muted-foreground)" }}
          >
            Отмена
          </button>
